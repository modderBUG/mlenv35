...
class VggNet(Model):
    def __init__(self):
        ...
        self.c1 = Conv2D(filters=4,kernel_size=(3,3),padding='same')
        self.b1 = BatchNormalization()
        self.a1 = Activation('relu')

        self.c2 = Conv2D(filters=4,kernel_size=(3,3),padding='same')
...
checkpoint_path = "./ckpt/04/AlexNet8.ckpt"   # 路径需要调整
...
# 保存权重
file = open('./weights/04.txt', 'w')   # 路径需要调整
