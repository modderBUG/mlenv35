...
class AlexNet8(Model):
    def __init__(self):
        ...
        self.c3 = Conv2D(filters=384,
                         kernel_size=(3,3),
                         padding='same',
                         activation='relu')
        self.c4 = Conv2D(filters=384,
                         kernel_size=(3,3),
                         padding='same',
                         activation='relu')
        self.c5 = Conv2D(filters=256,
                         kernel_size=(3,3),
                         padding='same',
                         activation='relu')
...
checkpoint_path = "./ckpt/03/AlexNet8.ckpt"   # 路径需要调整
...
# 保存权重
file = open('./weights/03.txt', 'w')   # 路径需要调整
